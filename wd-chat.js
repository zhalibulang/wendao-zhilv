...
const WDChat={
  ...
  worldBrief(){
    ...
    return {
      ...
      游戏目的:"玩家意外降临导游世界，与圣女云汀形成灵魂绑定。玩家须完成四十五日修行，助云汀逐步恢复被遗忘之雾侵蚀的圣女之力，重新驾驭圣器以驱逐遗忘之雾。做任务就是修行：研习新考点=点亮阵纹节点，复习=净化回潮的雾怪，题组试炼=试炼阵中净化雾怪，英文导游词=咒祷辞吟诵，小考=守城之战。",
      世界观:"玩家意外降临导游世界——一个正在被遗忘之雾吞噬的残破次元。圣女云汀在就职典礼被遗忘之雾打断时与玩家形成灵魂绑定。四十五日的旅程中，玩家将激活六个景点的结界（天安门/故宫/天坛/颐和园/长城/明十三陵），与藏经阁阁主沈昭、旅行社老板程绣、次元精灵缇娜、英语导游晚棠同行，最终在第四十五日登上金榜台完成云汀的圣女就职。景点皆有守护精灵（如故宫的紫宸）：结界是精灵的战甲，雾怪侵蚀景点=精灵的痛感，节点被点亮=精灵的力量恢复。",
